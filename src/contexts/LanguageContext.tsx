...
export const LanguageProvider: React.FC<LanguageProviderProps> = ({ children }) => {
  ...
  const translations = {
    es: {
      ...
      'pricing.starter.desc': 'Perfecto para agencias pequeñas que están comenzando',
      'pricing.starter.feature1': '50 scripts por mes',
      'pricing.starter.feature2': 'Acceso a GPT-4 y Claude',
      'pricing.starter.feature3': 'Templates básicos',
      'pricing.starter.feature4': 'Analytics básicos',
      'pricing.starter.feature5': 'Soporte por email',
      'pricing.starter.feature6': 'Exportación PDF/DOCX',
      'pricing.professional.name': 'Professional',
      'pricing.professional.desc': 'La elección más popular para agencias en crecimiento',
      'pricing.professional.feature1': '200 scripts por mes',
      'pricing.professional.feature2': 'Todos los modelos de IA',
      'pricing.professional.feature3': 'Personalización de marca',
      'pricing.professional.feature4': 'Analytics avanzados',
      'pricing.professional.feature5': 'Soporte prioritario',
      'pricing.professional.feature6': 'A/B Testing',
      'pricing.professional.feature7': 'Colaboración en equipo',
      'pricing.professional.feature8': 'Acceso a API',
      'pricing.enterprise.name': 'Enterprise',
      'pricing.enterprise.desc': 'Solución completa para agencias grandes y corporativos',
      'pricing.enterprise.feature1': 'Scripts ilimitados',
      'pricing.enterprise.feature2': 'Modelos de IA premium',
      'pricing.enterprise.feature3': 'White-label completo',
      'pricing.enterprise.feature4': 'Analytics predictivos',
      'pricing.enterprise.feature5': 'Soporte 24/7 dedicado',
      'pricing.enterprise.feature6': 'Integración CRM/ERP',
      'pricing.enterprise.feature7': 'Gestión multi-cliente',
      'pricing.enterprise.feature8': 'SLA garantizado',
      'pricing.enterprise.feature9': 'Capacitación personalizada',
    ...
    en: {
      ...
      'pricing.starter.feature1': '50 scripts per month',
      'pricing.starter.feature2': 'Access to GPT-4 and Claude',
      'pricing.starter.feature3': 'Basic templates',
      'pricing.starter.feature4': 'Basic analytics',
      'pricing.starter.feature5': 'Email support',
      'pricing.starter.feature6': 'PDF/DOCX export',
      'pricing.professional.name': 'Professional',
      'pricing.professional.desc': 'The most popular choice for growing agencies',
      'pricing.professional.feature1': '200 scripts per month',
      'pricing.professional.feature2': 'All AI models',
      'pricing.professional.feature3': 'Brand customization',
      'pricing.professional.feature4': 'Advanced analytics',
      'pricing.professional.feature5': 'Priority support',
      'pricing.professional.feature6': 'A/B Testing',
      'pricing.professional.feature7': 'Team collaboration',
      'pricing.professional.feature8': 'API access',
      'pricing.enterprise.name': 'Enterprise',
      'pricing.enterprise.desc': 'Complete solution for large agencies and corporations',
      'pricing.enterprise.feature1': 'Unlimited scripts',
      'pricing.enterprise.feature2': 'Premium AI models',
      'pricing.enterprise.feature3': 'Complete white-label',
      'pricing.enterprise.feature4': 'Predictive analytics',
      'pricing.enterprise.feature5': 'Dedicated 24/7 support',
      'pricing.enterprise.feature6': 'CRM/ERP integration',
      'pricing.enterprise.feature7': 'Multi-client management',
      'pricing.enterprise.feature8': 'Guaranteed SLA',
      'pricing.enterprise.feature9': 'Custom training',
