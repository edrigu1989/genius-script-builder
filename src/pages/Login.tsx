...
const Login = () => {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center p-4 ${isDark ? 'bg-gray-900 text-gray-100' : 'bg-gray-50 text-gray-900'}`}>
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center p-2 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl mb-4">
            <Sparkles className="h-8 w-8 text-white" />
          </div>
          <h1 className="text-3xl font-bold">MarketingGenius</h1>
          <p className="text-muted-foreground mt-2">Tu asistente de marketing con IA</p>
        </div>
          ...
          <CardFooter className="flex flex-col space-y-4">
            <div className="relative w-full">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white dark:bg-gray-800 px-2 text-muted-foreground">O continúa con</span>
              </div>
            </div>
